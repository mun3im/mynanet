...
- Hypothesis: Minimal model still >95% accuracy
"""
...
def get_config():
    ...
    parser.add_argument("--tcn_channels", type=int, default=16, help="TCN channel width (64, 96, 128)")
...
class TrainingLogger:
    ...
    def __init__(self, output_dir):
        ...
        with open(self.log_path, 'w') as f:
            f.write("=" * 80 + "\n")
            f.write("MYGARDENBIRD TCN TRAINING REPORT (Model 4h - TCN Lightweight)\n")
            f.write("=" * 80 + "\n")
    ...
    def log_hyperparameters(self, config):
        ...
        with open(self.log_path, 'a') as f:
            ...
            f.write("\nModel Architecture:\n")
            f.write(f"  Model Type:             Temporal Convolutional Network (TCN) - LIGHTWEIGHT VARIANT\n")
...
def main():
    ...
    # Create model
    print(f"\n{'=' * 70}")
    print("CREATING LIGHTWEIGHT TCN MODEL (16 channels, 5 blocks)")
    print(f"{'=' * 70}")
