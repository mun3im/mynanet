#!/usr/bin/env python3
"""
Model 4l - TCN Ultra: Maximum capacity TCN for absolute highest accuracy
- Based on 4k optimized variant
- Kernel: 5 (proven best from ablation studies)
- Channels: 128 (maximum capacity for 64x300 spectrograms)
- Receptive field: Larger per layer with kernel=5
- Goal: Absolute maximum accuracy, trading off model size
"""
...
def get_config():
    ...
    parser.add_argument("--tcn_channels", type=int, default=128, help="TCN channel width (64, 96, 128)")
...
class TrainingLogger:
    ...
    def __init__(self, output_dir):
        ...
        with open(self.log_path, 'w') as f:
            f.write("=" * 80 + "\n")
            f.write("MYGARDENBIRD TCN TRAINING REPORT (Model 4l - TCN Ultra)\n")
            f.write("=" * 80 + "\n")
    ...
    def log_hyperparameters(self, config):
        ...
        with open(self.log_path, 'a') as f:
            ...
            f.write("\nModel Architecture:\n")
            f.write(f"  Model Type:             Temporal Convolutional Network (TCN) - ULTRA VARIANT\n")
...
def main():
    ...
    # Create model
    print(f"\n{'=' * 70}")
    print("CREATING ULTRA TCN MODEL (kernel_size=5, channels=128)")
    print(f"{'=' * 70}")
