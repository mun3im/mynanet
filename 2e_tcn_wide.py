...
- Hypothesis: More filters = higher accuracy but larger model
"""
...
def get_config():
    ...
    parser.add_argument("--tcn_channels", type=int, default=64, help="TCN channel width (WIDE: 64 filters)")
...
class TrainingLogger:
    ...
    def __init__(self, output_dir):
        ...
        with open(self.log_path, 'w') as f:
            f.write("=" * 80 + "\n")
            f.write("MYGARDENBIRD TCN TRAINING REPORT (Model 4c - TCN Wide)\n")
            f.write("=" * 80 + "\n")
    ...
    def log_hyperparameters(self, config):
        ...
        with open(self.log_path, 'a') as f:
            ...
            f.write("\nModel Architecture:\n")
            f.write(f"  Model Type:             Temporal Convolutional Network (TCN) - WIDE VARIANT\n")
