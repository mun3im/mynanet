...
def get_config():
    ...
    output_dir_name = (
        f"results/5a_squeezenet_64x300_ptq_"
...
def fire_module(x, squeeze_filters, expand_filters, name, use_bypass=False):
    ...
    # Bypass connection (v1.1): add input if dimensions match
