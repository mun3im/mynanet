...
- Hypothesis: Deeper = more capacity but training challenges
"""
...
class TrainingLogger:
    ...
    def __init__(self, output_dir):
        ...
        with open(self.log_path, 'w') as f:
            f.write("=" * 80 + "\n")
            f.write("MYGARDENBIRD TCN TRAINING REPORT (Model 4d - TCN Deep)\n")
            f.write("=" * 80 + "\n")
    ...
    def log_hyperparameters(self, config):
        ...
        with open(self.log_path, 'a') as f:
            ...
            f.write("\nModel Architecture:\n")
            f.write(f"  Model Type:             Temporal Convolutional Network (TCN) - DEEP VARIANT\n")
...
def main():
    ...
    # Create model
    print(f"\n{'=' * 70}")
    print("CREATING DEEP TCN MODEL (9 blocks)")
    print(f"{'=' * 70}")
