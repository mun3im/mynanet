...
| Model | Description        | INT8 KB | Seed | Linux FP32 % | Linux INT8 % | Linux Runtime | macOS FP32 % | macOS INT8 % | macOS Runtime |
| ----- | ------------------ | ------- | ---- | ------------ | ------------ | ------------- | ------------ | ------------ | ------------- |
...
| 1g    | DS+SE+Res+Burooj Ghani | 371.8   | 94.26 ± 0.28   | 94.21 ± 0.36     | 26m           | 94.67 ± 0.08   | 94.72 ± 0.24     | 49m           | —          | ✗   |
...
### TABLE 4: Per-seed results

| Model | n_mels | Platform | Seed | Linux FP32 % | Linux INT8 % | Linux Runtime | macOS FP32 % | macOS INT8 % | macOS Runtime |
| ----- | ------ | -------- | ---- | ------------ | ------------ | ------------- | ------------ | ------------ | ------------- |
| 1a    | 48     | L        | 42   | 92.92        | 93.06        | 24m           | 93.06        | 93.19        | 43m           |
| 1a    | 48     | L        | 100  | 93.75        | 93.75        | 40m           | 93.75        | 93.61        | 40m           |
| 1a    | 48     | L        | 786  | 92.64        | 92.50        | 22m           | 93.06        | 92.78        | 40m           |
| 1a    | 64†    | L        | 42   | 93.75        | 93.61        | 28m           | 93.75        | 93.61        | 48m           |
| 1a    | 64†    | L        | 100  | 92.92        | 93.19        | 27m           | 92.08        | 92.08        | 22m           |
| 1a    | 64†    | L        | 786  | 93.33        | 93.19        | 28m           | 94.72        | 94.17        | 58m           |
| 1a    | 80     | L        | 42   | 92.50        | 92.50        | 53m           | 92.22        | 91.94        | 37m           |
| 1a    | 80     | L        | 100  | 91.94        | 91.94        | 1h13m         | 89.58        | 89.31        | 35m           |
| 1a    | 80     | L        | 786  | 92.36        | 92.50        | 1h12m         | 94.17        | 93.89        | 1h04m         |
...
| 1i    | 48     | L        | 42   | 94.44        | 94.58        | 20m           | 94.17        | 94.44        | 37m           |
| 1i    | 48     | L        | 100  | 95.69        | 95.56        | 20m           | 94.31        | 94.17        | 37m           |
| 1i    | 48     | L        | 786  | 93.47        | 93.75        | 20m           | 94.72        | 95.14        | 36m           |
| 1i    | 64†    | L        | 42   | 93.89        | 94.44        | 24m           | 94.31        | 94.58        | 43m           |
| 1i    | 64†    | L        | 100  | 94.31        | 94.17        | 24m           | 94.44        | 93.75        | 42m           |
| 1i    | 64†    | L        | 786  | 93.47        | 93.47        | 20m           | 94.72        | 94.44        | 42m           |
...
| 1j    | 48     | L        | 42   | 93.75        | 93.89        | 35m           | 95.00        | 95.00        | 34m           |
| 1j    | 48     | L        | 100  | 95.42        | 95.28        | 41m           | 95.14        | 95.28        | 34m           |
| 1j    | 48     | L        | 786  | 94.17        | 94.44        | 37m           | 95.28        | 95.28        | 35m           |
| 1j    | 64†    | L        | 42   | 94.03        | 94.31        | 52m           | 93.89        | 94.17        | 1h 20m        |
| 1j    | 64†    | L        | 100  | 95.14        | 95.42        | 53m           | 94.72        | 95.14        | 1h 15m        |
| 1j    | 64†    | L        | 786  | 94.58        | 95.00        | 53m           | 93.89        | 94.17        | 34m           |
| 1j    | 80     | L        | 42   | 94.58        | 94.44        | 1h05m         | 93.47        | 93.47        | 55m           |
| 1j    | 80     | L        | 100  | 94.86        | 94.72        | 1h08m         | 94.17        | 94.17        | 1h02m         |
| 1j    | 80     | L        | 786  | 94.44        | 94.31        | 47m           | 94.44        | 94.31        | 1h01m         |

### TABLE 5: Summary (n=3 seeds)
...
| ----- | ------ | -------- | ------------------ | ------------------ | ------------- | ------------------ | ------------------ | ------------- |
| 1a    | 48     | L        | 93.10 ± 0.58       | 93.10 ± 0.63       | 29m           | 93.29 ± 0.40       | 93.19 ± 0.42       | 41m           |
| 1a    | 64†    | L        | 93.33 ± 0.20       | 93.33 ± 0.20       | 28m           | 93.52 ± 1.34       | 93.29 ± 1.08       | 42m           |
| 1a    | 80     | L        | 92.27 ± 0.29       | 92.31 ± 0.32       | 1h06m         | 91.99 ± 2.34       | 91.71 ± 2.34       | 45m           |
...
| 1i    | 48     | L        | 94.53 ± 1.11       | **94.63** ± 0.91   | 20m           | 94.40 ± 0.28       | **94.58** ± 0.49   | 37m           |
| 1i    | 64†    | L        | 93.89 ± 0.34       | 94.03 ± 0.41       | 23m           | 94.49 ± 0.21       | **94.26** ± 0.44   | 42m           |
| 1i    | 80     | L        | 93.29 ± 0.69       | 93.47 ± 0.24       | 31m           | 93.66 ± 1.26       | 93.84 ± 0.97       | 56m           |
| 1i    | 96     | M        |                    |                    |               | 91.90 ± 2.08       | 92.13 ± 2.00       | 54m           |
| 1j    | 48     | L        | 94.45 ± 0.87       | 94.54 ± 0.70       | 38m           | 95.14 ± 0.14       | **95.19** ± 0.16   | 34m           |
| 1j    | 64†    | L        | 94.58 ± 0.55       | **94.91** ± 0.56   | 52m           | 94.17 ± 0.48       | **94.49** ± 0.57   | 1h 03m        |
| 1j    | 80     | L        | 94.63 ± 0.21       | 94.49 ± 0.21       | 1h00m         | 94.03 ± 0.50       | 94.00 ± 0.43       | 59m           |
...
> Last updated: 2026-05-09 (all 1a+1i+1j mel sweeps complete on both L+M; 1c×80 L seeds 100+786 pending)


---
# SERIES 2 — TCN variants (12-class mygardenbird)
---
...
| Model | Description                 | INT8 KB | Seed | Linux FP32 % | Linux INT8 % | Linux Runtime | macOS FP32 % | macOS INT8 % | macOS Runtime |
| ----- | --------------------------- | ------- | ---- | ------------ | ------------ | ------------- | ------------ | ------------ | ------------- |
| 2a    | TCN Baseline                | 526.8   | 42   | 79.86        | 79.58        | 15m           | 60.83        | 45.56        | 38m           |
| 2a    |                             |         | 100  | 81.25        | 81.67        | 14m           | 67.36        | 39.17        | 35m           |
| 2a    |                             |         | 786  | 77.78        | 78.33        | 14m           | 60.42        | 38.89        | 36m           |
| 2b    | TCN Shallow                 | 452.6   | 42   | 81.53        | 81.53        | 11m           | 55.42        | 28.33        | 29m           |
| 2b    |                             |         | 100  | 79.03        | 80.00        | 12m           | 63.47        | 14.03        | 26m           |
| 2b    |                             |         | 786  | 82.92        | 82.22        | 12m           | 66.67        | 33.06        | 28m           |
| 2c    | TCN No Residual             | 524.4   | 42   | 84.31        | 85.42        | 13m           | 74.31        | 55.83        | 36m           |
| 2c    |                             |         | 100  | 81.39        | 82.50        | 13m           | 78.06        | 45.00        | 36m           |
| 2c    |                             |         | 786  | 82.78        | 82.92        | 14m           | 71.25        | 41.25        | 23m           |
| 2d    | TCN Lightweight             | 133.1   | 42   | 60.00        | 60.83        | 6m            | 40.69        | 32.92        | 15m           |
| 2d    |                             |         | 100  | 60.97        | 61.11        | 6m            | 35.14        | 34.58        | 12m           |
| 2d    |                             |         | 786  | 54.31        | 56.25        | 6m            | 41.53        | 26.94        | 12m           |
| 2e    | TCN Wide                    | 526.8   | 42   | 78.89        | 79.03        | 13m           | 38.06        | 19.44        | 36m           |
| 2e    |                             |         | 100  | 80.28        | 79.86        | 12m           | 64.03        | 30.00        | 35m           |
| 2e    |                             |         | 786  | 82.22        | 82.36        | 14m           | 46.67        | 25.56        | 35m           |
| 2f    | TCN Deep                    | 765.4   | 42   | 71.11        | 71.11        | 20m           | 56.81        | 46.25        | 1h13m         |
| 2f    |                             |         | 100  | 76.39        | 74.58        | 22m           | 50.97        | 31.25        | 1h12m         |
| 2f    |                             |         | 786  | 71.53        | 72.08        | 22m           | 46.94        | 22.50        | 59m           |
| 2g    | TCN Kernel=2                | 430.8   | 42   | 78.61        | 78.47        | 13m           | 55.42        | 9.86         | 32m           |
| 2g    |                             |         | 100  | 72.50        | 69.86        | 11m           | 54.03        | 16.39        | 32m           |
| 2g    |                             |         | 786  | 70.00        | 70.42        | 13m           | 62.92        | 28.06        | 28m           |
| 2h    | TCN Kernel=5                | 718.8   | 42   | 83.06        | 82.22        | 15m           | 65.00        | 20.14        | 36m           |
| 2h    |                             |         | 100  | 80.69        | 80.28        | 14m           | 67.50        | 24.72        | 36m           |
| 2h    |                             |         | 786  | 78.61        | 77.78        | 15m           | 62.50        | 9.17         | 36m           |
| 2k    | TCN + SE                    | 1480.1  | 42   | 85.97        | 85.69        | 18m           | 43.19        | 13.47        | 54m           |
| 2k    |                             |         | 100  | 86.53        | 87.08        | 16m           | 14.03        | 8.33         | 27m           |
| 2k    |                             |         | 786  | 83.06        | 82.64        | 16m           | 47.64        | 10.97        | 55m           |
| 2l    | Pre-act Causal Residual TCN | 2274.1  | 42   | 91.11        | 90.83        | 14m           | 93.61        | 68.75†       | 1h 30m        |
| 2l    |                             |         | 100  | 93.06        | **93.19**    | 14m           | 93.33        | 69.58†       | 1h 35m        |
| 2l    |                             |         | 786  | 92.64        | 92.64        | 14m           | 92.08        | 59.31†       | 1h 45m        |
...
###  TABLE 8: Per see results Series 3
...
- `1k_ultralight_dscnn_wide.py` — trains 1k (UltraLight DS-CNN Wide: DS+Res+Wide, no SE; native 64×300 input; **needs CSV-split adaptation before running via run script**)
...
- `2m_tcn1d_raw.py` — **1D TCN on raw waveform** (ported from 4j_tcn1d_dual_stage, now deleted): causal, 48000-sample input, dilations [1,2,4,8,16,32], 32→64 filters, BatchNorm+SpatialDropout1D
...
Miscellaneous architectures evaluated during exploration. All dump results into `results_mygardenbird_4_{platform}/`.
- `4a_squeezenet_v11.py` — SqueezeNet v1.1 adapted for 64×300 spectrograms; Fire modules (squeeze 1×1 + expand 1×1/3×3 parallel), bypass connections, ~1.2M params, targeting ~300 KB INT8 (was 5a)
- `4b_shufflenetv2_v11.py` — ShuffleNetV2-1.0x full size for 64×300 mel-spectrograms; channel shuffle (groups=2), DW-separable convs, stages 116/232/464/1024ch, ~2.1M params / ~2300 KB INT8 — run at full size to establish accuracy ceiling (was 5b)
- `4c_shufflenetv2_compact.py` — ShuffleNetV2-Compact: same stage structure as 4b but channels 48/96/192, final conv 384ch; ~366K params, **476 KB INT8** — within H7 512 KB flash limit
- `4d_nanodepthwise_v11.py` — NanoDepthwise-CNN v1.1: 4-stage DW-separable blocks (32→64→128→192 channels), no skip connections, ultra-compact ~100K params targeting <50 KB INT8 for multi-model Cortex-M7 deployment (was 4c)
- `4e_nanodepthwise_v12.py` — NanoDepthwise-CNN v1.2: 3-stage DW-separable blocks (16→32→64), ultra-minimal ~15–20K params targeting ~20–25 KB INT8, designed for gated pipeline (activity detector pre-filters, then this classifier) on M7 (was 4d)
- `4f_matchboxnet_64x300.py` — MatchboxNet-3×2×64 (was 4e)
- `4g_matchboxnet_regularized_64x300.py` — MatchboxNet + strong regularization (was 4f)
- `4h_matchboxnet_wider_64x300.py` — MatchboxNet-3×2×128 wider (was 4g)
- `4i_transformer_encoder.py` — Pure Transformer Encoder baseline (was 4h)
- `4k_depthwise_cnn.py` — Depthwise Separable CNN baseline: Conv2D(32) stem + 3 DW-separable blocks (64→128→256), ReLU6, GAP + Dense(128), ~80K params (was 4j)
- ~~`4j_tcn1d_dual_stage.py`~~ — deleted; superseded by `2m_tcn1d_raw.py` (same 1D raw-audio TCN concept, properly ported)
- ~~`4l_ultralight_dscnn_wide.py`~~ — renamed to `1k_ultralight_dscnn_wide.py` (moved to Series 1; no match in Series 1)
- `_retired_3a_transformer_encoder.py` — retired original (superseded by 4i)
