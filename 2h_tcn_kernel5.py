...
- Hypothesis: Larger kernel = fewer layers needed
"""
...
class TrainingLogger:
    ...
    def __init__(self, output_dir):
        ...
        with open(self.log_path, 'w') as f:
            f.write("=" * 80 + "\n")
            f.write("MYGARDENBIRD TCN TRAINING REPORT (Model 4f - TCN Kernel5)\n")
            f.write("=" * 80 + "\n")
    ...
    def log_hyperparameters(self, config):
        ...
        with open(self.log_path, 'a') as f:
            ...
            f.write("\nModel Architecture:\n")
            f.write(f"  Model Type:             Temporal Convolutional Network (TCN) - KERNEL5 VARIANT\n")
...
def main():
    ...
    # Create model
    print(f"\n{'=' * 70}")
    print("CREATING TCN MODEL (kernel_size=5)")
    print(f"{'=' * 70}")
