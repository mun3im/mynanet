...
def get_config():
    ...
    output_dir_name = (
        ...
        f"3e_mobilenetv3_width075_64x300_"
        f"mels64_"
...
class TrainingLogger:
    ...
    def __init__(self, output_dir):
        ...
        with open(self.log_path, 'w') as f:
            f.write("=" * 80 + "\n")
            f.write("ABLATION 2F: MOBILENETV3SMALL WIDTH=0.75 @ 64×300 NATIVE\n")
            f.write("=" * 80 + "\n")
...
def create_mobilenetv3_small_64x300(num_classes, input_shape, dropout=0.2, width_mult=0.75):
    ...
    return keras.Model(inputs, outputs, name="MobileNetV3Small_Width075_64x300")
...
def main():
    ...
    print(f"\nAblation 2f: MobileNetV3Small Width=0.75 @ 64×300 (NATIVE)")
    ...
    # Create model
    print(f"\n{'=' * 70}")
    print("CREATING MOBILENETV3SMALL WIDTH=0.75 MODEL (64×300 NATIVE)")
    print(f"{'=' * 70}")
    model = create_mobilenetv3_small_64x300(num_classes, config['input_shape'], config['dropout'], width_mult=0.75)
    model.summary()
    ...
    print("FINAL RESULTS")
    print(f"{'=' * 70}")
    print(f"Model:                   2f_mobilenetv3_width075 (64×300 NATIVE)")
