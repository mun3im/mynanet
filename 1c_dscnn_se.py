...
class TrainingLogger:
    ...
    def log_final_results(self, fp32_acc, int8_acc, model_sizes,
        ...
        with open(self.log_path, 'a') as f:
            ...
            f.write(f"1c_dscnn_se,{config['dropout']},{config['augmentation_mode']},"
...
def ds_conv_block_se_res(x, filters, kernel_size=(3, 3), strides=(1, 1),
                          block_id=0, use_se=True, use_residual=False, se_reduction=16):
    """
...
def create_dscnn_se_res(num_classes, input_shape, dropout=0.2):
    ...
    x = ds_conv_block_se_res(x, 64, block_id=1, use_se=True, use_residual=False, se_reduction=4)
