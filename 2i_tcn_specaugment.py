#!/usr/bin/env python3
"""
Model 4m - TCN SpecAugment: TCN with SpecAugment augmentation
...
- Goal: Test SpecAugment impact on TCN accuracy
"""
...
class TrainingLogger:
    ...
    def __init__(self, output_dir):
        ...
        with open(self.log_path, 'w') as f:
            f.write("=" * 80 + "\n")
            f.write("MYGARDENBIRD TCN TRAINING REPORT (Model 4m - TCN SpecAugment)\n")
            f.write("=" * 80 + "\n")
    ...
    def log_hyperparameters(self, config):
        ...
        with open(self.log_path, 'a') as f:
            ...
            f.write("\nModel Architecture:\n")
            f.write(f"  Model Type:             Temporal Convolutional Network (TCN) - SPECAUGMENT VARIANT\n")
...
def main():
    ...
    # Create model
    print(f"\n{'=' * 70}")
    print("CREATING TCN MODEL WITH SPECAUGMENT (kernel_size=5, channels=96)")
    print(f"{'=' * 70}")
